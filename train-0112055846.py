...
op_64a911f6_fac2_4a44_90b5_657301324169 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "train-{{ ts_nodash }}",
    },
    volumes=[],
    volume_mounts=[],
    secrets=[],
